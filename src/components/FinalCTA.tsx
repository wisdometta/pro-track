    ...
    <section className="py-20 px-4 sm:px-6 bg-gradient-to-br from-blue-950 via-blue-900 to-blue-800 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        >
          ...
          {/* Call + WhatsApp — side by side on mobile */}
          <div className="grid grid-cols-2 sm:contents gap-3 w-full sm:w-auto">
            <a
              href={`tel:${PHONE}`}
              className="py-4 sm:py-4 sm:px-6 bg-white/10 hover:bg-white/20 text-white font-bold rounded-xl border border-white/20 active:scale-95 transition-all duration-200 text-sm flex items-center justify-center gap-2"
            >
            ...
            <a
              ...
              className="py-4 px-6 bg-white hover:bg-gray-50 border border-gray-200 text-[#25D366] font-bold rounded-xl active:scale-95 transition-all duration-300 flex items-center justify-center gap-2"
            >
