        ...
        >
          ...
          <div className="grid grid-cols-2 sm:contents gap-3 w-full sm:w-auto">
            ...
            <a
              ...
              className="py-4 sm:py-4 sm:px-6 bg-[#25D366] hover:bg-[#20b858] text-white font-bold rounded-xl active:scale-95 transition-all duration-200 text-sm flex items-center justify-center gap-2"
            >
