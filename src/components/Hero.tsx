            ...
            <div className="flex flex-col gap-3 w-full sm:flex-row sm:w-auto">
              ...
              <div className="grid grid-cols-2 gap-3 sm:contents">
                ...
                <a
                  ...
                  className="py-4 sm:py-3.5 sm:px-7 bg-white hover:bg-gray-50 border border-gray-200 text-[#25D366] font-bold rounded-xl active:scale-95 transition-all duration-300 flex items-center justify-center gap-2 text-sm"
                >
