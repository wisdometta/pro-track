      ...
      >
        <div className="grid grid-cols-3 divide-x divide-white/10">
          ...
          <a
            ...
            className="flex flex-col items-center justify-center gap-1 py-3.5 bg-[#25D366] hover:bg-[#20b858] active:scale-95 transition-all duration-200"
          ...
          >
            ...
            <span className="text-white text-[11px] font-bold tracking-wide leading-none">WhatsApp</span>
          </a>
        </div>
      </motion.div>

      {/* ── Desktop floating WhatsApp bubble (md+) ── */}
      <motion.a
        href={`https://wa.me/${WHATSAPP_NUMBER}?text=${WHATSAPP_MSG}`}
        target="_blank"
        rel="noopener noreferrer"
        className="hidden md:flex fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] rounded-full items-center justify-center shadow-xl hover:bg-[#20b858] hover:scale-110 active:scale-95 transition-all duration-300"
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
