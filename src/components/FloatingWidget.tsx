  ...
  return (
    <>
      ...
      >
        <div className="grid grid-cols-3 divide-x divide-white/10">
          ...
          >
            ...
            <span className="text-[#25D366] text-[11px] font-bold tracking-wide leading-none">WhatsApp</span>
          </a>
        </div>
      </motion.div>
      ...
      <motion.a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="hidden md:flex fixed bottom-6 right-6 z-50 w-14 h-14 bg-white border border-gray-200 rounded-full items-center justify-center shadow-xl hover:bg-gray-50 hover:scale-110 active:scale-95 transition-all duration-300"
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
